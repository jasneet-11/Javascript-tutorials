...
for 33 here the output will give as string. after running statements 10 and 11 we will chaange this to 33abcdef. output=>NaN
 now we change the value to  null and see what happens using console.log(typeof null )  output=> 0
...
//Be careful while checking the value of NaN. It means that value was not converted as it was not a complete number.
//NOTES:- 
/*
35=>35
35abcde=>NaN and it`s type is number
true=>1; false=>0 vice-versa also true
""=> false (empty string gives false value)
"jasneet"=>true
*/
...
let str3 = str1+ str2 //No subraction only addition
console.log(str3); 
*/ 
/*
console.log("1"+2); //12
...
//let num1,num2,num3
// don't use tricky behaviour to write code
//num1 = num2 = num3 = 8+2       such code dont improve the readability of the code and are not preferred.
...
let x11 = 10;
const y11= ++x11; // x is 11; y is 11
console.log([x11,y11]);
let x20 = 3n;
const y20 = ++x20; // x2 is 4n; y2 is 4n
console.log([x20,y20]); 
